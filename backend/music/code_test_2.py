...
# 搜索链接
# search_url = 'https://webcollects.kugou.com/v2/web/time.js?appid=1000&_t=1732021541758&_r=0.5995409194007384&sign=fcc4ee3842ad93731402a481b0bad3f6'
...
def save(audio_id):
    ...
    """
    print(audio_name, play_url, lyrics)
    # 对于音频发送请求，获取二进制数据
